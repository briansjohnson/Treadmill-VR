...
namespace VRTK
{
    ...
    public abstract class VRTK_ObjectControl : MonoBehaviour
    {
        ...
        protected DirectionDevices controllerUsed = DirectionDevices.LeftController;
        ...
        protected Transform strafeControllerUsed;
        public GameObject StrafeCylinder;
        ...
        protected virtual void OnEnable()
        {
            ...
            strafeControllerUsed = LeftOrRightStrafe();
            CylinderMovement();
        }
        ...
        /// <summary>
        /// Checking Enum used for Strafe
        /// </summary>
        protected virtual Transform LeftOrRightStrafe()
        {
           switch(controllerUsed)
            {
                case DirectionDevices.LeftController:
                    return strafeControllerUsed;
                case DirectionDevices.RightController:
                    return strafeControllerUsed; 
            }
            return null;
        ...
        protected virtual void CylinderMovement()
        {
            if (VRTK_DeviceFinder.GetControllerLeftHand(true))
            {
               StrafeCylinder.transform.Translate(-10000f, 0, 0);
            }
            if (VRTK_DeviceFinder.GetControllerRightHand(true))
            {
                StrafeCylinder.transform.Translate(10000f, 0, 0);
            }
